...
const Home = () => {
  ...
  const services = [
    {
      ...
      description: "Premium spa therapies that restore balance and glow — from therapeutic massages to mindful facials.",
      image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      link: "/wellness-spa",
      category: "Wellness Spa",
      features: ["Therapeutic Massage", "Facial Treatments", "Body Therapies", "Ayurvedic Healing"]
    },
    {
      id: 2,
      title: "Unisex Salon",
      subtitle: "Redefine Your Style, Elevate Your Confidence",
      description: "Modern cuts, color artistry, and grooming for all — crafted by expert stylists.",
      image: "https://images.unsplash.com/photo-1520637736862-4d197d17c80a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      link: "/salon",
      category: "Unisex Salon",
      features: ["Hair Styling", "Color Treatments", "Grooming", "Specialized Care"]
    },
    {
      id: 3,
      title: "Makeup",
      subtitle: "Unveil the Beauty, Shine with Confidence",
      description: "Signature looks for bridal, events, and editorials — designed to enhance your natural elegance.",
      image: "https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      link: "/makeup",
      category: "Makeup",
      features: ["Bridal Makeup", "Event Styling", "Photography", "Special Occasions"]
    }
  ]
  ...
  const features = [
    {
      ...
      description: "Luxury spa experiences using finest natural products and advanced techniques",
      color: "from-primary-400 to-primary-600"
    },
    {
      icon: <Heart className="w-8 h-8" />,
      title: "Holistic Wellness",
      description: "Complete well-being approach nurturing both physical and mental health",
      color: "from-warm-400 to-warm-600"
    },
    {
      icon: <Leaf className="w-8 h-8" />,
      title: "Natural & Organic",
      description: "Organic treatments that are safe for you and environmentally conscious",
      color: "from-accent-400 to-accent-600"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Expert Therapists",
      description: "Certified professionals with years of experience in exceptional service",
  ...
  const stats = [
    ...
    { number: "15+", label: "Premium Services", icon: <Star className="w-6 h-6" /> },
    { number: "10+", label: "Expert Therapists", icon: <Users className="w-6 h-6" /> },
    { number: "100%", label: "Satisfaction Rate", icon: <Award className="w-6 h-6" /> }
  ]
  ...
  const testimonials = [
    {
      name: "Priya Sharma",
      role: "Regular Client",
      content: "Nagomi has transformed my self-care routine. The serene atmosphere and expert treatments make every visit a rejuvenating experience.",
      rating: 5,
      image: "https://images.unsplash.com/photo-1494790108755-2616b9a0f4c9?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80"
    },
    {
      name: "Anjali Verma",
      role: "Spa Enthusiast",
      content: "The Japanese-inspired philosophy and authentic treatments at Nagomi create a perfect harmony of relaxation and wellness.",
      rating: 5,
    ...
    },
    {
      name: "Meera Gupta",
      role: "Beauty Lover",
      content: "From spa treatments to salon services, Nagomi offers everything under one roof with exceptional quality and care.",
      rating: 5,
    ...
    <span className="inline-block bg-primary-500/20 backdrop-blur-sm text-primary-200 px-6 py-2 rounded-full text-sm font-medium tracking-wide">
      Bihar's Premier Wellness Destination
          ...
          <motion.h1
            ...
            className="hero-title mb-8  backdrop-blur-sm rounded-2xl p-4 inline-block"
          >
          ...
          >
            Experience the harmony of Japanese-inspired wellness philosophy
            in Bihar's most serene spa and salon sanctuary
          </motion.p>
        ...
        <div className="container-custom relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center bg-gradient-to-r from-primary-500 to-primary-700 text-white px-6 py-2.5 rounded-full mb-6 shadow-glow">
              ...
              <span className="font-display tracking-wide">Welcome to your soft era</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-8 max-w-2xl">
              Discover a modern sanctuary where beauty meets serenity and self-care turns into soul-care. 
              Inspired by the Japanese philosophy of harmony and graceful living, Nagomi offers spa therapies, grooming, and styling designed to help you pause, reset, and glow.
            </p>

            {/* Quick value chips from site data */}
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-10">
              {["Expert therapists & stylists", "Women-exclusive spa", "Japanese-inspired rituals", "Premium products", "Personalized care", "Zen-inspired ambience"].map((text, i) => (
                <div key={i} className="flex items-center gap-2 bg-white/80 backdrop-blur-md border border-white/60 rounded-xl px-4 py-3 shadow-soft">
          ...
          >
            ...
            <div className="glass-card p-8 relative overflow-hidden">
              ...
              <h3 className="section-heading">This isn’t just a salon. Not just only spa.</h3>
              <p className="text-gray-600 mb-6">It’s a movement — a mood — a modern sanctuary for those who crave more than surface beauty.</p>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { title: "One ritual", sub: "Mindful practices that center you", color: "from-rose-500 to-pink-600", icon: <Flower2 className="w-6 h-6" /> },
                  { title: "One experience", sub: "A holistic journey of transformation", color: "from-purple-500 to-indigo-600", icon: <Heart className="w-6 h-6" /> },
                  { title: "One step closer", sub: "Discover your authentic beauty", color: "from-emerald-500 to-teal-600", icon: <Sparkles className="w-6 h-6" /> },
                ].map((item, idx) => (
                  <div key={idx} className="relative rounded-2xl p-5 bg-white/80 backdrop-blur-md border border-white/60 shadow-soft hover:shadow-glow transition-all duration-500">
                    <div className={`mb-3 inline-flex items-center justify-center w-10 h-10 rounded-xl text-white shadow-soft bg-gradient-to-r ${item.color}`}>
                      {item.icon}
                    </div>
                    <div className="font-semibold text-gray-900">{item.title}</div>
                    <div className="text-sm text-gray-600 leading-relaxed">{item.sub}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                { n: "10+", l: "Expert Therapists", color: "from-blue-400 to-blue-600" },
                { n: "100%", l: "Satisfaction Rate", color: "from-emerald-400 to-emerald-600" },
                { n: "15+", l: "Premium Treatments", color: "from-purple-400 to-purple-600" },
              ].map((s, i) => (
                <div key={i} className="text-center rounded-2xl p-6 bg-white/90 border border-white/60 shadow-soft">
                  <div className={`w-14 h-14 mx-auto mb-3 rounded-xl flex items-center justify-center text-white bg-gradient-to-r ${s.color}`}> 
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="section-subtitle">
              Experience the perfect blend of traditional wisdom and modern luxury
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="flex justify-center flex-wrap gap-4 mt-12">
              {['All', 'Wellness Spa', 'Unisex Salon', 'Makeup'].map((category) => (
                <motion.button
                  key={category}
            ...
            {services
              ...
              .map((service, index) => (
                ...
                >
                  ...
                  <div className="p-8">
                    <h3 className="text-2xl font-serif font-bold mb-2 text-gray-900">{service.title}</h3>
                    <p className="text-primary-600 font-medium mb-3">{service.subtitle}</p>
        ...
        <div className="container-custom relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-white/90 mb-10 leading-relaxed max-w-2xl">
              Luxury, care, and craft — brought together in a serene, Japanese-inspired space. 
              We pair premium products with mindful rituals so every visit feels restorative and elevating.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {features.map((f, i) => (
                ...
                >
                  ...
                  <div className="text-sm text-white/80 leading-relaxed">{f.description}</div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link to="/contact-us" className="btn-secondary border-white text-black hover:bg-white hover:text-black">
                Book Appointment
              </Link>
              <Link to="/about-us" className="btn-ghost text-black border-white">
                Learn More
              </Link>
            </div>
          </motion.div>
              ...
              <div className="rounded-3xl bg-white/10 backdrop-blur-2xl p-8">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  <div className="group flex items-center gap-2 text-white/90">
                    <span className="icon-rot"><Shield className="w-5 h-5" /></span> <span className="text-sm">Hygiene First</span>
                  </div>
                  <div className="group flex items-center gap-2 text-white/90">
                    <span className="icon-rot"><Award className="w-5 h-5" /></span> <span className="text-sm">Certified Team</span>
                  </div>
                  <div className="group flex items-center gap-2 text-white/90">
                    <span className="icon-rot"><Clock className="w-5 h-5" /></span> <span className="text-sm">On-time Service</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {whyChoosePoints.map((point, index) => (
                    <div key={index} className="flex items-center gap-3 bg-white/95 text-gray-800 rounded-xl px-4 py-3 shadow-soft">
